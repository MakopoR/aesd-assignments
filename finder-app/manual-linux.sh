...
if [ ! -e ${OUTDIR}/linux-stable/arch/${ARCH}/boot/Image ]; then
    ...
    make -C /tmp/aeld/linux-stable ARCH=arm64 CROSS_COMPILE=aarch64-none-linux-gnu- mrproper
    make -C /tmp/aeld/linux-stable ARCH=arm64 CROSS_COMPILE=aarch64-none-linux-gnu- defconfig
    make -C /tmp/aeld/linux-stable -j4 ARCH=arm64 CROSS_COMPILE=aarch64-none-linux-gnu- all
    make -C /tmp/aeld/linux-stable ARCH=arm64 CROSS_COMPILE=aarch64-none-linux-gnu- dtbs
fi
